...
import cc.sc.common.utils.Collections3;
...
import cc.sc.modules.sys.service.OfficeService;
...
public class RoleController extends BaseController {
	...
	public String save(Role role, Model model,
		...
		if (!UserUtils.getUser().isAdmin()
				&& role.getSysData().equals(Global.YES)) {
	...
	public String outrole(Integer userId, Integer roleId,
			RedirectAttributes redirectAttributes) {
		if (Global.isDemoMode()) {
			addMessage(redirectAttributes, "演示模式，不允许操作！");
	...
	public String assignRole(Role role, Integer[] idsArr,
			RedirectAttributes redirectAttributes) {
		if (Global.isDemoMode()) {
			addMessage(redirectAttributes, "演示模式，不允许操作！");
