...
import cc.sc.modules.sys.utils.DictUtils;
...
public class OfficeController extends BaseController {
	...
	public String save(Office office, Model model,
		...
		Integer id = null == office.getParentId() ? 0 : office.getParentId();
		return "redirect:" + adminPath + "/sys/office/list?id=" + id
				+ "&parentIds=" + office.getParentIds();
	}
